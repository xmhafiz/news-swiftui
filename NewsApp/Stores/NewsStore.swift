...
struct NewsStore {
    ...
    func getAll() -> [News]{
        ...
        return [
            ...
            News(id: UUID().uuidString, title: "Excepteur sint", description: description, date: "December 30, 2020", author: "John Smith", imageName: "image-1"),
            News(id: UUID().uuidString, title: "Lorem Ipsum", description: description, date: "December 3, 2020", author: "Zamelo Marcelo", imageName: "image-2"),
            News(id: UUID().uuidString, title: "Excepteur sint occaecat cupidatat non proident", description: description, date: "December 4, 2020", author: "John Smith", imageName: "image-3")
        ]
    }
}
